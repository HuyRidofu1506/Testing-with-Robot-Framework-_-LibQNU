...
*** Test Cases ***
Verify Condition Password Info     ${data_login_cardnum}	${data_login_password}	   ${password}     ${password_confirm}    ${info_condition_password}      ${info_condition_pw_confirm}        ${info_compore_password}


*** Keywords ***
Condition Password Info
    [Arguments]     ${data_login_cardnum}	${data_login_password}    ${password}     ${password_confirm}     ${info_condition_password}      ${info_condition_pw_confirm}        ${info_compore_password}
