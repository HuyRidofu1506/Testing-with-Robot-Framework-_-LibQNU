...
Library     DataDriver   ../../data/data_person_info.xlsx  sheet_name=Sheet2
...
*** Test Cases ***
Verify Change Data Person Info With Password     ${data_login_cardnum}	${data_login_password}	${education}	${phone}	${industry_group}	${mobile}	${office_address}	${email}	${permanent_address}    ${password}     ${password_confirm}     ${MSG_ALERT_INFO_CONTENT}


*** Keywords ***
Change Data Person Info
    [Arguments]     ${data_login_cardnum}	${data_login_password}	${education}	${phone}	${industry_group}	${mobile}	${office_address}	${email}	${permanent_address}    ${password}     ${password_confirm}     ${MSG_ALERT_INFO_CONTENT}
